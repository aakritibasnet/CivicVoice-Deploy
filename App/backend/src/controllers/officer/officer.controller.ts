...
import {
  ...
  uploadTaskProof,
  getOfficerReports,
  getOfficerReportDetail,
  addReportComment,
  addTaskComment,
  getOfficerNotifications,
  getOfficerUnreadCount,
...
export async function taskDetail(req: Request, res: Response, next: NextFunction) {
  try {
    const officerId = req.user!.id;
...
export async function uploadProof(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const type = (req.body.type as string) || "completion";
...
export async function reportDetail(req: Request, res: Response, next: NextFunction) {
  try {
    const officerId = req.user!.id;
...
export async function commentOnReport(req: Request, res: Response, next: NextFunction) {
  try {
    const officerId = req.user!.id;
...
export async function commentOnTask(req: Request, res: Response, next: NextFunction) {
  try {
    const officerId = req.user!.id;
    const { content } = req.body;
    if (!content?.trim()) {
...
export async function markNotifRead(req: Request, res: Response, next: NextFunction) {
  try {
    const officerId = req.user!.id;
...
export async function markAllNotifsRead(req: Request, res: Response, next: NextFunction) {
  try {
    const officerId = req.user!.id;
