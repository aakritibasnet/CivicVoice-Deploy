...
import {
  ...
  getOfficerActivity,
} from "@/services/ward/department.service";
...
export async function listOfficersController(
  req: Request,
  res: Response,
  next: NextFunction,
) {
...
export async function getOfficerDetailController(
  req: Request,
  res: Response,
  next: NextFunction,
) {
...
export async function assignOfficerController(
  req: Request,
  res: Response,
  next: NextFunction,
) {
